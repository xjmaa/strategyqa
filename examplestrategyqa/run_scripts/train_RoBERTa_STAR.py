...
def run(args):
    ...
    #print(twentyquestions_serialization_dir)
    twentyquestions_serialization_dir = "experiments/for_STAR_1_twentyquestions_9"
    ...
    print(" ".join(sys.argv))
    boolq_dir = train_main()
    print("path to boolq dir ",boolq_dir)
    return boolq_dir
